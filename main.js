  ...
  websites: {
    ...
    params: {
      ...
      features: {
        type: "multiselect",
        label: "Функции",
        options: ["Адаптивный дизайн", "PWA", "SEO оптимизация", "Корзина покупок", "Блог", "Комментарии", "Поиск", "Смена темы (По умолчанию темная)", "Смена темы (По умолчанию светлая)", "Бекенд", "Аккаунты и подписки", "Галерея изображения", "Отзывы"],
