  ...
  websites: {
    ...
    params: {
      ...
      color: {
        ...
        options: ["Тайские подсказки (#5c71e5)", "Убразный (#db0f00)", "Прочитка (#f58631)", "Глубокие прятки (#276fdb)", "Лимонный (#f5ee22)", "Обнаружение (#26d13c)", "Угольный (#000000)", "Ванильный (#fffff7)", "Подход звезды (#e431f5)", "Другой"],
        default: "Тайские подсказки (#5c71e5)",
      },
      features: {
        type: "multiselect",
        label: "Функции",
        options: ["Адаптивный дизайн", "PWA", "SEO оптимизация", "Корзина покупок", "Блог", "Комментарии", "Поиск", "Смена темы (По умолчанию темная)", "Смена темы (По умолчанию светлая)", "Бекенд", "Аккаунты и подписки", "Галерея изображения", "Отзывы", "Код в одном файле"],
