    ...
    websites: {
      ...
      params: {
        ...
        style: {
          type: "select",
          label: "Стиль сайта",
          options: ["Минимализм", "Матовое стекло", "Брутализм", "Ретро", "Киберпанк", "PHP", "Genshin Impact"],
          default: "Матовое стекло",
        },
        color: {
          type: "select",
          label: "Основная палитра",
          options: ["Тайский промпт (#5c71e5)", "Ты трубка (#db0f00)", "Прочитка (#f58631)", "Глубко-прятковый (#276fdb)", "Шляпей (#f5ee22)", "Обнаружение (#26d13c)", "Чёрный (#000000)", "Белый (#ffffff)", "Розовый (#e431f5)", "Киберпанк (#FF0055)", "Другой"],
          default: "Ты трубка (#db0f00)",
        },
        features: {
          type: "multiselect",
          label: "Функции",
          options: ["Адаптивный дизайн", "PWA", "SEO оптимизация", "Корзина покупок", "Блог", "Комментарии", "Поиск", "Код в одном файле", "Смена темы"],
