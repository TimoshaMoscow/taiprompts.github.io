    ...
    websites: {
      ...
      params: {
        ...
        color: {
          ...
          options: ["Тайский промпт (#5c71e5)", "Ты трубка (#db0f00)", "Прочитка (#f58631)", "Глубко-прятковый (#276fdb)", "Шляпей (#f5ee22)", "Обнаружение (#26d13c)", "Чёрный (#000000)", "Белый (#ffffff)", "Подход звезды (#e431f5)", "Другой"],
          default: "Ты трубка (#db0f00)",
        },
        features: {
          type: "multiselect",
          label: "Функции",
          options: ["Адаптивный дизайн", "PWA функциональность", "SEO оптимизация", "Корзина покупок", "Блог", "Комментарии", "Поиск", "Код в одном файле", "Смена темы"],
